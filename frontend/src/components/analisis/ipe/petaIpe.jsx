      ...
      <div className="relative" style={{ height: 480 }}>
        ...
        <div className="absolute bottom-4 left-4 z-[400]">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-2 bg-white dark:bg-slate-800 border-2 border-slate-300 rounded-xl shadow-lg hover:bg-indigo-50 hover:border-indigo-500 transition-all active:scale-95 text-slate-800 dark:text-white font-semibold"
          >
