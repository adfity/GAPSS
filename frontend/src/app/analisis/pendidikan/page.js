...
import { 
  ...
  ClipboardList, Search, Eye, EyeOff
} from 'lucide-react';
...
export default function PendidikanPage() {
  ...
  useEffect(() => {
    ...
    const suggestions = hasilAnalisis.matched_features.features
      ...
      .map(f => ({
        ...
        kategori: f.properties.education_analysis.kategori,
        warna: f.properties.education_analysis.warna
      }))
      .slice(0, 5);
  ...
  // ══════════════════════════════════════════════════════════════════
  // DOWNLOAD DATASET — kirim ke backend (openpyxl, formatted XLSX)
  // ══════════════════════════════════════════════════════════════════
  const unduhDataset = async (jenisDataset) => {
    ...
    if (jenisDataset === 'ALL') {
      // Unduh ketiganya secara berurutan
  ...
  // Export hasil analisis (ringkasan)
  ...
  // Warna berdasarkan indikator terpilih
  ...
  const ambilDataTabelTerfilter = () => {
    ...
    if (kategoriTerpilih !== 'SEMUA') {
      fitur = fitur.filter(f => f.properties?.education_analysis?.kategori === kategoriTerpilih);
    }
    return fitur;
  };
  ...
  const hitungKategori = () => {
    ...
    return {
      KRITIS: f.filter(x => x.properties?.education_analysis?.kategori === 'KRITIS').length,
      SEDANG: f.filter(x => x.properties?.education_analysis?.kategori === 'SEDANG').length,
      BAIK:   f.filter(x => x.properties?.education_analysis?.kategori === 'BAIK').length
    };
  };
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-900 dark:text-slate-100 transition-colors duration-300">
        ...
        <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-lg p-8">
            ...
            <div className="space-y-3 mb-6">
              <button onClick={() => setPilihanIndikator('ALL')}
                ...
                <div className="flex items-center justify-between">
                  ...
                  {pilihanIndikator === 'ALL' && <div className="w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center"><div className="w-2 h-2 rounded-full bg-white"></div></div>}
                </div>
              </button>

              <button onClick={() => setPilihanIndikator('RLS')}
                ...
                <div className="flex items-center justify-between">
                  ...
                  {pilihanIndikator === 'RLS' && <div className="w-5 h-5 rounded-full bg-purple-500 flex items-center justify-center"><div className="w-2 h-2 rounded-full bg-white"></div></div>}
                </div>
              </button>

              <button onClick={() => setPilihanIndikator('APS')}
                ...
                <div className="flex items-center justify-between">
                  ...
                  {pilihanIndikator === 'APS' && <div className="w-5 h-5 rounded-full bg-blue-500 flex items-center justify-center"><div className="w-2 h-2 rounded-full bg-white"></div></div>}
                </div>
              </button>

              <button onClick={() => setPilihanIndikator('RASIO')}
                ...
                <div className="flex items-center justify-between">
                  ...
                  {pilihanIndikator === 'RASIO' && <div className="w-5 h-5 rounded-full bg-green-500 flex items-center justify-center"><div className="w-2 h-2 rounded-full bg-white"></div></div>}
                </div>
              </button>
            </div>
      ...
      {modalSaveTerbuka && (
        <div className="fixed inset-0 z-[2000] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 w-full max-w-md p-8">
            ...
            <div className="flex gap-3">
              <button onClick={() => setModalSaveTerbuka(false)} className="flex-1 px-6 py-3 bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 rounded-xl font-bold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">Batal</button>
      ...
      <div className={`fixed inset-0 bg-white dark:bg-slate-900 ${modeBersih ? 'top-0' : 'top-16'}`}>
              ...
              <GeoJSON
                ...
                style={(fitur) => {
                  ...
                  if (indikatorTerpilih !== 'SEMUA') {
                    ...
                    const map = { RLS: dp.RLS, APS: dp.SKOR_APS, RASIO: dp.RASIO_RATA };
                    if (map[indikatorTerpilih] == null) terlihat = false;
                  }
                ...
                onEachFeature={(fitur, lapisan) => {
                  ...
                  if (indikatorTerpilih === 'SEMUA') {
                    indikatorHTML = `
                      <div style="background:linear-gradient(135deg,#f5f3ff,#ede9fe);padding:6px;border-radius:6px;border-left:2px solid #8b5cf6;">
                      ...
                      <div style="background:linear-gradient(135deg,#eff6ff,#dbeafe);padding:6px;border-radius:6px;border-left:2px solid #3b82f6;">
                      ...
                      <div style="background:linear-gradient(135deg,#f0fdf4,#dcfce7);padding:6px;border-radius:6px;border-left:2px solid #10b981;">
                    ...
                    indikatorHTML = `<div style="background:linear-gradient(135deg,#f5f3ff,#ede9fe);padding:8px;border-radius:8px;border-left:3px solid #8b5cf6;">
                    ...
                    indikatorHTML = `<div style="background:linear-gradient(135deg,#eff6ff,#dbeafe);padding:8px;border-radius:8px;border-left:3px solid #3b82f6;">
                    ...
                    indikatorHTML = `<div style="background:linear-gradient(135deg,#f0fdf4,#dcfce7);padding:8px;border-radius:8px;border-left:3px solid #10b981;">
        ...
        {/* KOORDINAT & SCALE & LEGEND & FILTER — KANAN ATAS */}
        {!modeBersih && (
              ...
              <div className="relative">
                ...
                {menuPilihanIndikatorTerbuka && (
                  <div className="absolute bottom-full mb-2 left-0 w-64 bg-white dark:bg-slate-800 rounded-xl shadow-2xl z-[1003] overflow-hidden border border-slate-200 dark:border-slate-700">
                    <button onClick={() => jalankanAnalisisBPS('ALL')} className="w-full text-left px-4 py-2 text-[10px] font-bold transition-all border-b border-slate-100 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-900/20">📊 Semua Indikator</button>
                    <button onClick={() => jalankanAnalisisBPS('RLS')} className="w-full text-left px-4 py-2 text-[10px] font-bold transition-all border-b border-slate-100 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-purple-50 dark:hover:bg-purple-900/20">📚 Rata-rata Lama Sekolah</button>
                    <button onClick={() => jalankanAnalisisBPS('APS')} className="w-full text-left px-4 py-2 text-[10px] font-bold transition-all border-b border-slate-100 dark:border-slate-700 text-slate-600 dark:text-slate-300 hover:bg-blue-50 dark:hover:bg-blue-900/20">🎓 Angka Partisipasi Sekolah</button>
                    <button onClick={() => jalankanAnalisisBPS('RASIO')} className="w-full text-left px-4 py-2 text-[10px] font-bold transition-all text-slate-600 dark:text-slate-300 hover:bg-green-50 dark:hover:bg-green-900/20">👥 Rasio Murid-Guru</button>
                  </div>
                )}
              </div>
              {hasilAnalisis && (
                <>
                  <button onClick={bukaModalSave}
        ...
        {hasilAnalisis && !modeBersih && (
          <div className="absolute bottom-0 left-0 right-0 z-[1001]">
                        ...
                        return (
                          <tr key={indeks} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-all">
                            ...
                            <td className="px-3 py-2">
                              <span className="px-2 py-1 rounded-lg text-[10px] font-bold border-2" style={{ borderColor: warna + '40', color: warna }}>{data.kategori}</span>
                            </td>
                          </tr>
                        );
                      })}
                          ...
                          <tr key={indeks} className="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-all">
                            ...
                            <td className="px-3 py-2">
                              <span className={`px-2 py-1 rounded-lg text-[10px] font-bold ${
                                ...
                                data.kategori === 'SEDANG' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300' :
            ...
            {/* METODOLOGI PANEL — DINAMIS + DOWNLOAD DATASET */}
            <div className={`bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 transition-all duration-300 shadow-2xl ${panelMetodologiTerbuka ? 'h-[340px] overflow-y-auto' : 'max-h-0 overflow-hidden'}`}>
              <div className="p-6 space-y-4">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    {/* TOMBOL DATASET — mirip halaman kesehatan */}
                    <div className="relative">
                      ...
                      {menuDatasetTerbuka && (
                        <div className="absolute top-full mt-2 right-0 w-56 bg-white dark:bg-slate-800 rounded-xl shadow-2xl z-[1002] overflow-hidden border border-slate-200 dark:border-slate-700">
                          <button onClick={() => unduhDataset('ALL')}
                          ...
                          <button onClick={() => unduhDataset('RLS')}
                            className="w-full text-left px-4 py-2 text-[10px] font-bold text-slate-600 dark:text-slate-300 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-all border-b border-slate-100 dark:border-slate-700">
                            {loadingDataset.RLS ? '⏳' : '📚'} Dataset RLS {loadingDataset.RLS && '(Memproses...)'}
                          </button>
                          <button onClick={() => unduhDataset('APS')}
                          ...
                          <button onClick={() => unduhDataset('RASIO')}
                            className="w-full text-left px-4 py-2 text-[10px] font-bold text-slate-600 dark:text-slate-300 hover:bg-green-50 dark:hover:bg-green-900/20 transition-all">
                ...
                {/* CATATAN APS — muncul jika SEMUA atau APS */}
                {(indikatorTerpilih === 'SEMUA' || indikatorTerpilih === 'APS') && (
                  <div className="bg-cyan-50 dark:bg-cyan-900/20 rounded-xl p-4 border-2 border-cyan-200 dark:border-cyan-800">
                    ...
                    <p className="text-xs text-cyan-700 dark:text-cyan-300 mb-3 leading-relaxed">
                      Skor APS Gabungan dihitung dengan merata-ratakan skor dari 4 kelompok umur: 7–12 tahun (SD), 13–15 tahun (SMP), 16–18 tahun (SMA/K), dan 19–23 tahun (Perguruan Tinggi). Bobot tertinggi karena mengukur aksesibilitas pendidikan secara langsung.
                    </p>
                      ...
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-1">
                            <span className="px-2 py-1 bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 text-xs font-bold rounded">Bobot: 30%</span>
                            <span className="text-xs text-purple-700 dark:text-purple-300 font-bold">📊 Rata-rata Laki-laki & Perempuan</span>
                          </div>
                        </div>
                      </div>
                      <p className="text-xs text-purple-800 dark:text-purple-200 mb-3">
                        Mengukur pencapaian pendidikan jangka panjang suatu provinsi. Semakin tinggi RLS, semakin baik kualitas SDM yang dihasilkan. Merupakan indikator outcome terpenting dalam sistem pendidikan.
                      </p>
                  ...
                  {(indikatorTerpilih === 'SEMUA' || indikatorTerpilih === 'APS') && (
                    <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border-l-4 border-blue-500">
                      ...
                      <p className="text-xs text-blue-800 dark:text-blue-200 mb-3">
                        Bobot tertinggi karena mengukur aksesibilitas pendidikan secara langsung dari 4 kelompok umur. Mencerminkan seberapa besar populasi usia sekolah yang benar-benar mengenyam pendidikan, dari SD hingga Perguruan Tinggi.
                      </p>
                      <div className="grid grid-cols-3 gap-2">
                  ...
                  {(indikatorTerpilih === 'SEMUA' || indikatorTerpilih === 'RASIO') && (
                    <div className="bg-green-50 dark:bg-green-900/20 rounded-xl p-4 border-l-4 border-green-500">
                      ...
                      <p className="text-xs text-green-800 dark:text-green-200 mb-3">
                        Rata-rata rasio murid per guru dari 4 jenjang pendidikan. Semakin rendah rasio, semakin ideal beban mengajar guru dan semakin baik kualitas pembelajaran. Bobot lebih rendah karena merupakan indikator input, bukan outcome langsung.
                      </p>
                      <div className="grid grid-cols-3 gap-2">
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-800/20 rounded-xl p-4 border-2 border-green-200 dark:border-green-800">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div className="bg-white dark:bg-slate-900 rounded-xl p-3 border border-yellow-200 dark:border-yellow-700">
                      ...
                      <div className="text-xs text-slate-600 dark:text-slate-300 mt-2">Perlu peningkatan bertahap di beberapa area</div>
                    </div>
                    <div className="bg-white dark:bg-slate-900 rounded-xl p-3 border border-red-200 dark:border-red-700">
                      ...
                      <div className="text-xs text-slate-600 dark:text-slate-300 mt-2">Memerlukan intervensi dan perhatian segera</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-xs text-blue-800 dark:text-blue-200 mb-3">
                    Pembobotan mengacu pada standar Kemendikbudristek dan UNESCO. APS mendapat bobot tertinggi (50%) karena merepresentasikan akses pendidikan secara langsung. RLS sebagai outcome jangka panjang mendapat 30%. Rasio Murid-Guru sebagai indikator input mendapat 20% namun krusial untuk kualitas pembelajaran.
                  </p>
                  <div className="bg-white dark:bg-slate-900 rounded-lg p-3 border border-blue-300 dark:border-blue-700">
            ...
            <div className="bg-white dark:bg-slate-900 border-t-2 border-slate-200 dark:border-slate-800 p-3 shadow-2xl">
              <div className="flex justify-center gap-2">
                <button onClick={() => { setPanelInfoTerbuka(!panelInfoTerbuka); setPanelTabelTerbuka(false); setPanelMetodologiTerbuka(false); setPanelKebijakanTerbuka(false); }}
                  ...
                  <Info size={14} /> Info {panelInfoTerbuka ? <ChevronDown size={14} /> : <ChevronUp size={14} />}
                </button>

                <button onClick={() => { setPanelTabelTerbuka(!panelTabelTerbuka); setPanelInfoTerbuka(false); setPanelMetodologiTerbuka(false); setPanelKebijakanTerbuka(false); }}
                  ...
                  <Table size={14} /> Tabel {panelTabelTerbuka ? <ChevronDown size={14} /> : <ChevronUp size={14} />}
                </button>

                <button onClick={() => { setPanelKebijakanTerbuka(!panelKebijakanTerbuka); setPanelInfoTerbuka(false); setPanelTabelTerbuka(false); setPanelMetodologiTerbuka(false); }}
                  ...
                  <ClipboardList size={14} /> Kebijakan {panelKebijakanTerbuka ? <ChevronDown size={14} /> : <ChevronUp size={14} />}
                </button>

                <button onClick={() => { setPanelMetodologiTerbuka(!panelMetodologiTerbuka); setPanelInfoTerbuka(false); setPanelTabelTerbuka(false); setPanelKebijakanTerbuka(false); }}
                  ...
                  <FileText size={14} /> Metodologi {panelMetodologiTerbuka ? <ChevronDown size={14} /> : <ChevronUp size={14} />}
                </button>
